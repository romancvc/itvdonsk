...
text_process_without_authorization2 = 'Если у вас возникли проблемы с программой 1С ' \
                                      ...
                                      ' - оставьте заявку. Для этого сначала введите ваше имя и ' \
                                      'номер телефона, по которому с вами свяжется менеджер.\n\n' \
                                      '<i>Например: Роман, 88001234567</i>'
...
text_process_without_authorization4 = 'Спасибо, мы получили данные для связи. Теперь просто \n<i><b>🎙запишите ' \
                                      'голосовое сообщение с вашей проблемой🎙</b></i> и ' \
                                      'вам перезвонит первый освободившийся' \
                                      ' специалист.\n\n'
...
get_password_text = 'Чтобы получить пароль - позвоните нам по телефону ниже 👇🏻\n' \
                    'После получения пароля нажмите кнопку для авторизации'
